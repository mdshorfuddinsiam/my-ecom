        ...
        (e = document.getElementById("kt_signin_change_email")) && (t = FormValidation.formValidation(e, {
            ...
            n.preventDefault(), console.log( "click"), t.validate().then((function(n) {
                ...
                "Valid" == n ? swal.fire({
                    ...
                    //   e.preventDefault();
                    //   fetch("{{ route('admin.email.update', ['id' => $admin->id]) }}", { 
                    //     method: 'post'
                    //   }).then(() => console.log('success'));
                    // });

                    // alert(document.getElementById('kt_signin_change_email').action);
                    // window.location = document.getElementById('kt_signin_change_email').action;
