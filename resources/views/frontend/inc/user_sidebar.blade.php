<div class="dashboard_sidebar">
  ...
  <ul class="dashboard_link">
    <li><a class="active" href="{{ route('home') }}"><i class="fas fa-tachometer"></i>Dashboard</a></li>
    ...
    <li><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="far fa-sign-out-alt"></i> Log out</a></li>
  </ul>
