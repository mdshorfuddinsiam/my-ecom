	...
	<div class="card">
	  ...
	  <div class="card-header border-0 pt-6">
	    ...
	    <div class="card-toolbar">
	    	<a href="{{ route('admin.products.index') }}" class="btn btn-primary" style="margin-right: 10px;"> Back (Products)</a>
	    	<a href="{{ route('admin.variants.create', ['product' => $product->id]) }}" class="btn btn-primary"><i class="fas fa-plus"></i> Variant Create</a>
	    </div>
	    <!--end::Card toolbar-->
	  </div>
	  <!--end::Card header-->
	  	...
	  	<table id="kt_datatable_dom_positioning" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
	  	    ...
	  	    <tbody>
	  	        ...
	  	        <tr>
	  	            ...
	  	            <td>
	  	            	<a href="{{ route('admin.variants.edit', ['product' => $product->id, 'variant' => $row->id ]) }}" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
	  	            	<a href="{{ route('admin.variants.delete', ['product' => $product->id, 'variant' => $row->id]) }}" class="btn btn-sm btn-danger delete"><i class="fas fa-trash"></i></a>
	  	            	...
	  	            	<span>
	  	            	    ...
	  	            	    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-auto min-w-200 mw-300px" data-kt-menu="true">
	  	            	        ...
	  	            	        <div class="menu-item px-3">
	  	            	            <a href="{{ route('admin.variantitems.index', ['product' => $product->id, 'variant' => $row->id]) }}" class="menu-link px-3">
	  	            	                Variant Item
	  	            	            </a>
	  	            	        </div>
	  	            	        <!--end::Menu item-->
...
@section('admin_js')
	...
	<script>
		$('.status').on('click', function (e) {
           ...
           $.ajax({
	           	url: "{{ route('admin.variants.update-status') }}",
	           	method: "POST",
	           	dateType: "JSON",
