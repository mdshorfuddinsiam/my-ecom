	    		...
	    		<div class="row">
	    			<div class="col-md-6">
	    				...
	    				<div class="fv-row mb-7">
	    				  ...
	    				  <!--end::Label-->
	    				  <!--begin::Input-->
	    				  <input type="number" name="selling_price" class="form-control form-control-solid mb-3 mb-lg-0 @error('selling_price') is-invalid @enderror" placeholder="0.00" value="{{ old('selling_price') ?? $product->selling_price }}" min="0.00" />
	    				  <!--end::Input-->
	    				  @error('selling_price')
	    				      <span class="invalid-feedback" role="alert">
	    				          <strong>{{ $message }}</strong>
