	    ...
	    <div class="card-body">
	    	...
	    	<form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
	    		...
	    		<div class="fv-row mb-7">
	    		  <!--begin::Label-->
	    		  <label class="required d-block fw-semibold fs-6 mb-5">Thumbnail Image</label>
	    		  <!--end::Label-->
	    			...
	    			<div class="col-md-6">
			    		...
			    		<div class="fv-row mb-7">
			    		  ...
			    		  <select name="brand_id" id="brand_id" class="form-select form-select-solid @error('brand_id') is-invalid @enderror" data-control="select2" data-placeholder="Select an option" data-allow-clear="true">
			    		      ...
			    		      <option {{ old('brand_id') == $row->id ? 'selected' : '' }} value="{{ $row->id }}">{{ $row->name }}</option>
			    		      @endforeach
			    		  </select>
			    		  @error('brand_id')
			    		      <span class="invalid-feedback" role="alert">
	    			...
	    			<div class="col-md-4">
	    				...
	    				<div class="fv-row mb-7">
	    				  ...
	    				  <select name="subsubcategory_id" class="form-select form-select-solid @error('subsubcategory_id') is-invalid @enderror" data-control="select2" data-placeholder="Select an option" data-allow-clear="true">
	    				      <option></option>
	    				      {{-- @foreach($categories as $row)
	    				      <option {{ old('subsubcategory_id') == $row->id ? 'selected' : '' }} value="{{ $row->id }}">{{ $row->name }}</option>
	    				      @endforeach --}}
	    				  </select>
	    		...
	    		<div class="row">
	    			...
	    			<div class="col-md-6">
	    				...
	    				<div class="fv-row mb-7">
	    				  ...
	    				  <!--end::Label-->
	    				  <!--begin::Input-->
	    				  <input type="text" name="discount_price" class="form-control form-control-solid mb-3 mb-lg-0 @error('discount_price') is-invalid @enderror" placeholder="0.00" value="{{ old('discount_price') }}" min="0.00" />
	    				  <!--end::Input-->
	    		...
	    		<div class="row">
	    			<div class="col-md-6">
	    				...
	    				<div class="fv-row mb-7">
	    				  ...
	    				  <!--end::Label-->
	    				  <!--begin::Input-->
	    				  <input type="date" name="start_discount_date" class="form-control form-control-solid mb-3 mb-lg-0 @error('start_discount_date') is-invalid @enderror" placeholder="" value="{{ old('start_discount_date') }}" />
	    				  <!--end::Input-->
	    			...
	    			<div class="col-md-6">
	    				...
	    				<div class="fv-row mb-7">
	    				  ...
	    				  <!--end::Label-->
	    				  <!--begin::Input-->
	    				  <input type="date" name="end_discount_date" class="form-control form-control-solid mb-3 mb-lg-0 @error('end_discount_date') is-invalid @enderror" placeholder="" value="{{ old('end_discount_date') }}" />
	    				  <!--end::Input-->
	    		...
	    		<div class="row">
	    			<div class="col-md-6">
			    		...
			    		<div class="fv-row mb-7">
			    		  ...
			    		  <select name="unit" class="form-select form-select-solid @error('unit') is-invalid @enderror" data-control="select2" data-placeholder="Select an option" data-allow-clear="true">
			    		      <option></option>
			    		      <option {{ old('unit') == "pc" ? 'selected' : '' }} value="pc">Piece</option>
	    			...
	    			<div class="col-md-6">
	    				...
	    				<div class="fv-row mb-7">
	    				  ...
	    				  <!--end::Label-->
	    				  <!--begin::Input-->
	    				  <input type="text" name="sku" class="form-control form-control-solid mb-3 mb-lg-0 @error('sku') is-invalid @enderror" placeholder="XYZ-12345" value="{{ old('sku') }}" />
	    				  <!--end::Input-->
	    				  @error('sku')
	    				      <span class="invalid-feedback" role="alert">
	    				          <strong>{{ $message }}</strong>
				...
				<div class="fv-row mb-7">
				  ...
				  <textarea type="text" name="short_description" class="form-control form-control-solid mb-3 mb-lg-0 @error('short_description') is-invalid @enderror" placeholder="Leave a description here">{{ old('short_description') }}</textarea>
				  <!--end::Input-->
				...
				<div class="fv-row mb-7">
				  ...
				  <div class="py-5" data-bs-theme="light">
				      <textarea name="long_description" id="long_description" class="@error('long_description') is-invalid @enderror">{!! old('long_description') !!}</textarea>
				  </div>
				  <!--end::Input-->
				...
				<div class="fv-row mb-7">
				  ...
				  <!--end::Label-->
				  <!--begin::Input-->
				  <input type="url" name="video_link" class="form-control form-control-solid mb-3 mb-lg-0 @error('video_link') is-invalid @enderror" placeholder="Video Link" value="{{ old('video_link') }}" />
				  <!--end::Input-->
				  @error('video_link')
				      <span class="invalid-feedback" role="alert">
				          <strong>{{ $message }}</strong>
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="fv-row mb-7">
						  ...
						  <div class="form-check form-switch form-check-custom form-check-solid">
						    <input name="is_new" class="form-check-input @error('is_new') is-invalid @enderror" type="checkbox" {{ old('is_new') == '1' ? 'checked' : '' }} value="1" id="is_new"/>
						...
						<div class="fv-row mb-7">
						  <!--begin::Input-->
						  <div class="form-check form-switch form-check-custom form-check-solid">
						    <input name="is_top" class="form-check-input @error('is_top') is-invalid @enderror" type="checkbox" {{ old('is_top') == '1' ? 'checked' : '' }} value="1" id="is_top"/>
						...
						<div class="fv-row mb-7">
						  <!--begin::Input-->
						  <div class="form-check form-switch form-check-custom form-check-solid">
						    <input name="is_today_deals" class="form-check-input @error('is_today_deals') is-invalid @enderror" type="checkbox" {{ old('is_today_deals') == '1' ? 'checked' : '' }} value="1" id="is_today_deals"/>
					...
					<div class="col-md-6">
						...
						<div class="fv-row mb-7">
						  <!--begin::Input-->
						  <div class="form-check form-switch form-check-custom form-check-solid">
						    <input name="is_featured" class="form-check-input @error('is_featured') is-invalid @enderror" type="checkbox" {{ old('is_featured') == '1' ? 'checked' : '' }} value="1" id="is_featured"/>
						...
						<div class="fv-row mb-7">
						  <!--begin::Input-->
						  <div class="form-check form-switch form-check-custom form-check-solid">
						    <input name="is_best" class="form-check-input @error('is_best') is-invalid @enderror" type="checkbox" {{ old('is_best') == '1' ? 'checked' : '' }} value="1" id="is_best"/>
