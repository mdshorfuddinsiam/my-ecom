...
@section('content')
	<div class="card shadow-sm">
	    <div class="card-header">
	        <h3 class="card-title">	Footer Social Create</h3>
	        <div class="card-toolbar">
	            <a href="{{ route('admin.footersocials.create') }}" class="btn btn-sm btn-light">
	    ...
	    <div class="card-body">
	    	...
	    	<form action="{{ route('admin.footersocials.store') }}" method="POST" >
	    		@csrf
	    		...
	    		<div class="fv-row mb-7">
	    		  ...
	    		  <!--end::Label-->
	    		  <!--begin::Input-->
	    		  <input type="text" name="icon" class="form-control form-control-solid mb-3 mb-lg-0 @error('icon') is-invalid @enderror" placeholder="fas fa-heart" value="{{ old('icon') }}" />
	    		  <!--end::Input-->
	    		  @error('icon')
	    		      <span class="invalid-feedback" role="alert">
	    		          <strong>{{ $message }}</strong>
