	...
	<div class="card">
	  ...
	  <div class="card-header border-0 pt-6">
	    ...
	    <div class="card-title">
	    	<h4>Footer Social Lists</h4>
	    </div>
	    <!--begin::Card title-->
	    <!--begin::Card toolbar-->
	    <div class="card-toolbar">
	    	<a href="{{ route('admin.footersocials.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Footer Social Create</a>
	    </div>
	    <!--end::Card toolbar-->
	  </div>
	  <!--end::Card header-->
	  	...
	  	<table id="kt_datatable_dom_positioning" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
	  	    ...
	  	    <tbody>
	  	        ...
	  	        <tr>
	  	            ...
	  	            <td>
	  	            	<a href="{{ route('admin.footersocials.edit', ['footersocial' => $row->id]) }}" class="btn btn-sm btn-info"><i class="fas fa-edit	"></i></a>
	  	            	<a href="{{ route('admin.footersocial.delete', ['footersocial' => $row->id]) }}" class="btn btn-sm btn-danger delete"><i class="fas fa-trash"></i></a>
	  	            </td>
	  	        </tr>
	  	        @endforeach
	  	    </tbody>
...
@section('admin_js')
	...
	<script>
		$('.status').on('click', function (e) {
           ...
           $.ajax({
	           	url: "{{ route('admin.footersocial.update-status') }}",
	           	method: "POST",
	           	dateType: "JSON",
