...
@section('content')
	<div class="card shadow-sm">
	    <div class="card-header">
	        <h3 class="card-title">Footer Grid Two Edit</h3>
	    ...
	    <div class="card-body">
	    	...
	    	<form action="{{ route('admin.footergridtwos.update', ['footergridtwo' => $footergridtwo->id]) }}" method="POST" >
	    		@csrf
	    		@method('PUT')
	    		...
	    		<div class="fv-row mb-7">
	    		  ...
	    		  <!--end::Label-->
	    		  <!--begin::Input-->
	    		  <input type="url" name="link" class="form-control form-control-solid mb-3 mb-lg-0 @error('link') is-invalid @enderror" placeholder="https://www.google.com/" value="{{ old('link') ?? $footergridtwo->link }}" />
	    		  <!--end::Input-->
	    		  @error('link')
	    		      <span class="invalid-feedback" role="alert">
	    		          <strong>{{ $message }}</strong>
