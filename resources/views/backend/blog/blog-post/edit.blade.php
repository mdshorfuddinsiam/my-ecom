...
@section('content')
	...
	<div class="card shadow-sm">
	    ...
	    <div class="card-body">
	    	...
	    	<form action="{{ route('admin.blogposts.update', ['blogpost' => $blogpost->id]) }}" method="POST" enctype="multipart/form-data">
	    		@csrf
	    		@method('PUT')
	    		...
	    		<div class="fv-row mb-7">
	    		  ...
	    		  <div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
	    		    ...
	    		    <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ $blogpost->image ? asset($blogpost->image) : asset('/uploads/no_image.jpg') }});"></div>
	    		...
	    		<div class="fv-row mb-7">
	    		  ...
	    		  <select name="blogcategory_id" class="form-select form-select-solid @error('blogcategory_id') is-invalid @enderror" data-control="select2" data-placeholder="Select an option" data-allow-clear="true">
	    		      ...
	    		      <option {{ old('blogcategory_id', $blogpost->blogcategory_id) == $row->id ? 'selected' : '' }} value="{{ $row->id }}">{{ $row->name }}</option>
	    		      @endforeach
	    		  </select>
	    		...
	    		<div class="fv-row mb-7">
	    		  ...
	    		  <!--end::Label-->
	    		  <!--begin::Input-->
	    		  <input type="text" name="title" class="form-control form-control-solid mb-3 mb-lg-0 @error('title') is-invalid @enderror" placeholder="Title" value="{{ old('title') ?? $blogpost->title }}" />
	    		  <!--end::Input-->
	    		  @error('title')
	    		      <span class="invalid-feedback" role="alert">
	    		          <strong>{{ $message }}</strong>
				...
				<div class="fv-row mb-7">
				  ...
				  <div class="py-5" data-bs-theme="light">
				      <textarea name="description" id="description" class="@error('description') is-invalid @enderror">{!! old('description') ?? $blogpost->description !!}</textarea>
				  </div>
				  <!--end::Input-->
	    		...
	    		<div class="fv-row mb-7">
	    		  ...
	    		  <select name="is_popular" class="form-select form-select-solid @error('is_popular') is-invalid @enderror" data-control="select2" data-placeholder="Select an option" data-allow-clear="true">
	    		      <option></option>
	    		      <option {{ old('is_popular', $blogpost->is_popular) == "1" ? 'selected' : '' }} value="1">Yes</option>
	    		      <option {{ old('is_popular', $blogpost->is_popular) == "0" ? 'selected' : '' }} value="0">No</option>
	    		  </select>
	    		  @error('is_popular')
	    		      <span class="invalid-feedback" role="alert">
	    		          <strong>{{ $message }}</strong>
	    		...
	    		<div class="fv-row mb-7">
	    		  ...
	    		  <!--end::Label-->
	    		  <!--begin::Input-->
	    		  <input type="text" name="seo_title" class="form-control form-control-solid mb-3 mb-lg-0 @error('seo_title') is-invalid @enderror" placeholder="Seo Title" value="{{ old('seo_title') ?? $blogpost->seo_title }}" />
	    		  <!--end::Input-->
	    		  @error('seo_title')
	    		      <span class="invalid-feedback" role="alert">
	    		          <strong>{{ $message }}</strong>
				...
				<div class="fv-row mb-7">
				  ...
				  <!--end::Label-->
				  <!--begin::Input-->
				  <textarea type="text" name="seo_description" class="form-control form-control-solid mb-3 mb-lg-0 @error('seo_description') is-invalid @enderror" placeholder="Leave a description here">{{ old('seo_description') ?? $blogpost->seo_description }}</textarea>
				  <!--end::Input-->
	    		...
	    		<div class="fv-row mb-7">
	    		  ...
	    		  <select name="status" class="form-select form-select-solid @error('status') is-invalid @enderror" data-control="select2" data-placeholder="Select an option" data-allow-clear="true">
	    		      <option></option>
	    		      <option {{ old('status', $blogpost->status) == "1" ? 'selected' : '' }} value="1">Active</option>
	    		      <option {{ old('status', $blogpost->status) == "0" ? 'selected' : '' }} value="0">Inactive</option>
	    		  </select>
	    		  @error('status')
	    		      <span class="invalid-feedback" role="alert">
	    		          <strong>{{ $message }}</strong>
