	...
	<div class="card">
	  ...
	  <div class="card-header border-0 pt-6">
	    ...
	    <div class="card-toolbar">
	    	<a href="{{ route('admin.colors.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Color Create</a>
	    </div>
	    <!--end::Card toolbar-->
	  </div>
	  <!--end::Card header-->
	  	...
	  	<table id="kt_datatable_dom_positioning" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
	  	    ...
	  	    <tbody>
	  	        ...
	  	        <tr>
	  	            ...
	  	            <td>
	  	            	<a href="{{ route('admin.colors.edit', ['color' => $row->id]) }}" class="btn btn-sm btn-info"><i class="fas fa-edit	"></i></a>
	  	            	<a href="{{ route('admin.color.delete', ['color' => $row->id]) }}" class="btn btn-sm btn-danger delete"><i class="fas fa-trash"></i></a>
	  	            </td>
	  	        </tr>
	  	        @endforeach
	  	    </tbody>
...
@section('admin_js')
	...
	<script>
		$('.status').on('click', function (e) {
           ...
           $.ajax({
	           	url: "{{ route('admin.color.update-status') }}",
	           	method: "POST",
	           	dateType: "JSON",
