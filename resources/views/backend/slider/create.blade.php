	    ...
	    <div class="card-body">
	    	...
	    	<form action="{{ route('admin.sliders.store') }}" method="POST" enctype="multipart/form-data">
	    		...
	    		<div class="fv-row mb-7">
	    		  ...
	    		  <!--end::Label-->
	    		  <!--begin::Input-->
	    		  <input type="text" name="type" class="form-control form-control-solid mb-3 mb-lg-0 @error('type') is-invalid @enderror" placeholder="Slider Type" value="{{ old('type') }}" />
	    		  <!--end::Input-->
	    		  @error('type')
	    		...
	    		<div class="fv-row mb-7">
	    		  ...
	    		  <!--end::Label-->
	    		  <!--begin::Input-->
	    		  <input type="text" name="starting_price" class="form-control form-control-solid mb-3 mb-lg-0 @error('starting_price') is-invalid @enderror" placeholder="0.00" value="{{ old('starting_price') }}" />
	    		  <!--end::Input-->
	    		...
	    		<div class="fv-row mb-7">
	    		  ...
	    		  <!--end::Label-->
	    		  <!--begin::Input-->
	    		  <input type="text" name="btn_text" class="form-control form-control-solid mb-3 mb-lg-0 @error('btn_text') is-invalid @enderror" placeholder="Button Text" value="{{ old('btn_text') }}" />
	    		  <!--end::Input-->
	    		  @error('btn_text')
	    		      <span class="invalid-feedback" role="alert">
	    		          <strong>{{ $message }}</strong>
	    		...
	    		<div class="fv-row mb-7">
	    		  ...
	    		  <!--end::Label-->
	    		  <!--begin::Input-->
	    		  <input type="url" name="btn_url" class="form-control form-control-solid mb-3 mb-lg-0 @error('btn_url') is-invalid @enderror" placeholder="Button Url" value="{{ old('btn_url') }}" />
	    		  <!--end::Input-->
	    		  @error('btn_url')
	    		      <span class="invalid-feedback" role="alert">
	    		          <strong>{{ $message }}</strong>
	    		...
	    		<div class="fv-row mb-7">
	    		  ...
	    		  <!--end::Label-->
	    		  <!--begin::Input-->
	    		  <input type="number" name="serial" class="form-control form-control-solid mb-3 mb-lg-0 @error('serial') is-invalid @enderror" placeholder="1" value="{{ old('serial') }}" />
	    		  <!--end::Input-->
	    		  @error('serial')
	    		      <span class="invalid-feedback" role="alert">
	    		          <strong>{{ $message }}</strong>
