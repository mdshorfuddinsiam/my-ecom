...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800&display=swap"
        rel="stylesheet">
    <title>One Shop || Admin Forget Password</title>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <ul>
                            ...
                            <li><a href="{{ route('admin.password.request') }}">admin forget password</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-5 m-auto">
                    <div class="wsus__forget_area">
                        ...
                        <a class="see_btn mt-4" href="{{ route('admin.login') }}">go to admin login</a>
                    </div>
                </div>
            </div>
        </div>
